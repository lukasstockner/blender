...
DefNode( CompositorNode, CMP_NODE_DILATEERODE2,   def_cmp_dilate_erode2,  "DILATEERODE2",   DilateErode2,     "Dilate/Erode (2)",  ""              )
...
DefNode( CompositorNode, CMP_NODE_SAMPLER        ,def_cmp_sampler,        "SAMPLER",        Sampler,          "Sampler",           ""              )
