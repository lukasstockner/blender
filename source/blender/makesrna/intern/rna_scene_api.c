...
static void rna_Scene_frame_set(Scene *scene, int frame, float subframe)
{
	...
	BKE_scene_update_for_newframe_ex(G.main->evaluation_context, G.main, scene, (1 << 20) - 1, false);
...
{
	BKE_scene_update_tagged_ex(G.main->evaluation_context, G.main, scene, false);
}
