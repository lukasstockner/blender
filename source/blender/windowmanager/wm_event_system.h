...
void        wm_event_do_handlers    (struct bContext *C);

void        wm_event_add_ghostevent (wmWindowManager *wm, wmWindow *win, int type, int time, void *customdata);

void        wm_event_do_notifiers   (struct bContext *C);

/* wm_keymap.c */

/* wm_dropbox.c */
void        wm_dropbox_free(void);
void        wm_drags_check_ops(struct bContext *C, wmEvent *event);
void        wm_drags_draw(struct bContext *C, wmWindow *win, rcti *rect);
