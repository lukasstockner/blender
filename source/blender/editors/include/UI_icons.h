...
DEF_ICON(RULER)
DEF_ICON(TOOLBAR_ADD)
DEF_ICON(TOOLBAR_DELETE)
DEF_ICON(TOOLBAR_DUP)
DEF_ICON(TOOLBAR_DUP_LINKED)
DEF_ICON(GREASE_DRAW)
DEF_ICON(GREASE_LINE)
DEF_ICON(GREASE_POLY)
DEF_ICON(GREASE_ERASE)
