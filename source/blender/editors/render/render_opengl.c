...
static void screen_opengl_render_apply(OGLRender *oglrender)
{
	...
	if (oglrender->is_sequencer) {
		...
		context = BKE_sequencer_new_render_data(oglrender->bmain->evaluation_context, oglrender->bmain,
...
static void screen_opengl_render_end(bContext *C, OGLRender *oglrender)
{
	...
	if (oglrender->timer) { /* exec will not have a timer */
		...
		BKE_scene_update_for_newframe(bmain->evaluation_context, bmain, scene, screen_opengl_layers(oglrender));
...
static bool screen_opengl_render_anim_step(bContext *C, wmOperator *op)
{
	...
	while (CFRA < oglrender->nfra) {
		...
		BKE_scene_update_for_newframe(bmain->evaluation_context, bmain, scene, lay);
		CFRA++;
	}
