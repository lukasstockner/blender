...
/* drawanim.c */
void draw_motion_paths_init(struct View3D *v3d, struct ARegion *ar);
void draw_motion_path_instance(struct Scene *scene,
                               struct Object *ob, struct bPoseChannel *pchan,
                               struct bAnimVizSettings *avs, struct bMotionPath *mpath);
void draw_motion_paths_cleanup(struct View3D *v3d);



/* drawobject.c */
void draw_object(struct Scene *scene, struct ARegion *ar, struct View3D *v3d, struct Base *base, const short dflag);
bool draw_glsl_material(struct Scene *scene, struct Object *ob, struct View3D *v3d, const char dt);
void draw_object_instance(struct Scene *scene, struct View3D *v3d, struct RegionView3D *rv3d, struct Object *ob, const char dt, int outline);
void draw_object_backbufsel(struct Scene *scene, struct View3D *v3d, struct RegionView3D *rv3d, struct Object *ob);
...
/* drawarmature.c */
bool draw_armature(struct Scene *scene, struct View3D *v3d, struct ARegion *ar, struct Base *base,
                   const short dt, const short dflag, const unsigned char ob_wire_col[4],
                   const bool is_outline);

/* drawmesh.c */
void draw_mesh_textured(struct Scene *scene, struct View3D *v3d, struct RegionView3D *rv3d,
...
void draw_depth(struct Scene *scene, struct ARegion *ar, struct View3D *v3d, int (*func)(void *), bool alphaoverride);
void draw_depth_gpencil(struct Scene *scene, struct ARegion *ar, struct View3D *v3d);
void ED_view3d_after_add(struct ListBase *lb, struct Base *base, const short dflag);
