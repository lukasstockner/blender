...
public:
    /**
      ...
      */
	void executePixel(float* color, float x, float y, MemoryBuffer *inputBuffers[]) = 0;
...
public:
	...
	void executePixel(float* outputValue, float x, float y, MemoryBuffer *inputBuffers[]);
};
