...
def bake(engine, obj, pass_type, pass_filter, object_id, pixel_array, bake_images, num_pixels, depth, result):
    import _cycles
    session = getattr(engine, "session", None)
    if session is not None:
        _cycles.bake(engine.session, obj.as_pointer(), pass_type, pass_filter, object_id, pixel_array.as_pointer(), bake_images.as_pointer(), num_pixels, depth, result.as_pointer())
