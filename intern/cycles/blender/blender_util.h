...
public:
	...
	bool check_recalc(BL::ID& id, BL::ID& data)
	{
		...
		b_new_update_id[data.ptr.data] = data.update_id();
	...
	{
		b_new_update_id[id.ptr.data] = id.update_id();
		b_recalc.insert(id.ptr.data);
	}
	...
	bool post_sync(bool do_delete = true)
	{
		...
		*scene_data = new_scene_data;
		...
		typename map<void*, int>::iterator it2;
		for(it2 = b_new_update_id.begin(); it2 != b_new_update_id.end(); it2++) {
			b_update_id[it2->first] = it2->second;
		}
		b_new_update_id.clear();
