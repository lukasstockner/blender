...
ccl_device_inline void path_state_init(ccl_addr_space KernelGlobals *kg, ccl_addr_space PathState *state, ccl_addr_space RNG *rng, int sample, ccl_addr_space Ray *ray)
{
...
ccl_device_inline void path_state_next(ccl_addr_space KernelGlobals *kg, ccl_addr_space PathState *state, int label)
{
...
ccl_device_inline uint path_state_ray_visibility(ccl_addr_space KernelGlobals *kg, PathState *state)
{
...
ccl_device_inline float path_state_terminate_probability(ccl_addr_space KernelGlobals *kg, ccl_addr_space PathState *state, const float3 throughput)
{
