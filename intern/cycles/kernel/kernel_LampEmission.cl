...
/*
 * Note on kernel_ocl_path_trace_LampEmission_SPLIT_KERNEL
 ...
 * Throughput_coop ------------------------------------|--- kernel_ocl_path_trace_LampEmission_SPLIT_KERNEL ---|--- PathRadiance_coop
 ...
 * parallel_samples -----------------------------------|                                                       |
 *
 * note : shader_data is neither input nor output. Its just filled and consumed in the same, kernel_ocl_path_trace_LampEmission_SPLIT_KERNEL, kernel.
 */
__kernel void kernel_ocl_path_trace_LampEmission_SPLIT_KERNEL(
