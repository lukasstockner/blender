...
ccl_device void svm_node_camera(ccl_addr_space KernelGlobals *kg, ccl_addr_space ShaderData *sd, float *stack, uint out_vector, uint out_zdepth, uint out_distance)
{
	float distance;
	float zdepth;
	float3 vector;
