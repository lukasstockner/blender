...
ccl_device void svm_node_combine_hsv(ccl_addr_space KernelGlobals *kg, ccl_addr_space ShaderData *sd, float *stack, uint hue_in, uint saturation_in, uint value_in, int *offset)
{
...
ccl_device void svm_node_separate_hsv(ccl_addr_space KernelGlobals *kg, ccl_addr_space ShaderData *sd, float *stack, uint color_in, uint hue_out, uint saturation_out, int *offset)
{
	uint4 node1 = read_node(kg, offset);
