...
ccl_device void svm_node_light_path(ccl_addr_space ShaderData *sd, float *stack, uint type, uint out_offset, int path_flag)
{
	float info = 0.0f;
...
ccl_device void svm_node_light_falloff(ccl_addr_space ShaderData *sd, float *stack, uint4 node)
{
