...
ccl_device void svm_node_normal(ccl_addr_space KernelGlobals *kg, ccl_addr_space ShaderData *sd, float *stack, uint in_normal_offset, uint out_normal_offset, uint out_dot_offset, int *offset)
{
	/* read extra data */
