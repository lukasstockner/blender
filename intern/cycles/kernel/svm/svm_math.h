...
ccl_device void svm_node_math(ccl_addr_space KernelGlobals *kg, ccl_addr_space ShaderData *sd, float *stack, uint itype, uint f1_offset, uint f2_offset, int *offset)
{
...
ccl_device void svm_node_vector_math(ccl_addr_space KernelGlobals *kg, ccl_addr_space ShaderData *sd, float *stack, uint itype, uint v1_offset, uint v2_offset, int *offset)
{
