...
ccl_device void svm_node_vector_transform(__ADDR_SPACE__ KernelGlobals *kg, __ADDR_SPACE__ ShaderData *sd, float *stack, uint4 node)
{
	...
	Transform tfm;
	bool is_object = (sd_fetch(object) != OBJECT_NONE);
