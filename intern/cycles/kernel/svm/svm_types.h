...
typedef enum NodeNewHairParametrization {
	NODE_NEW_HAIR_ABSORPTION = 0,
	NODE_NEW_HAIR_PHYSICAL = 1,
	NODE_NEW_HAIR_COLOR = 2,
	NODE_NEW_HAIR_HUMAN = 3,
	NODE_NEW_HAIR_NUM,
} NodeNewHairParametrization;
