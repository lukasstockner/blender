...
ccl_device void svm_node_mix(ccl_addr_space KernelGlobals *kg, ccl_addr_space ShaderData *sd, float *stack, uint fac_offset, uint c1_offset, uint c2_offset, int *offset)
{
	/* read extra data */
