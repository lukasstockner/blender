...
ccl_device void svm_node_fresnel(ccl_addr_space ShaderData *sd, float *stack, uint ior_offset, uint ior_value, uint node)
{
...
ccl_device void svm_node_layer_weight(ccl_addr_space ShaderData *sd, float *stack, uint4 node)
{
