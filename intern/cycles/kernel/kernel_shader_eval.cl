...
/*
 * Note on kernel_ocl_path_trace_ShaderEvaluation kernel
 ...
 * rng_coop -------------------------------------------|--- kernel_ocl_path_trace_ShaderEvaluation ---|--- shader_data
...
__kernel void kernel_ocl_path_trace_ShaderEvaluation(
