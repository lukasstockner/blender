...
ccl_device bool volume_shader_extinction_sample(ccl_addr_space KernelGlobals *kg, ShaderData *sd, PathState *state, float3 P, float3 *extinction)
{
	sd->P = P;
...
ccl_device bool volume_shader_sample(ccl_addr_space KernelGlobals *kg, ShaderData *sd, PathState *state, float3 P, VolumeShaderCoefficients *coeff)
{
	sd->P = P;
...
ccl_device bool volume_stack_is_heterogeneous(ccl_addr_space KernelGlobals *kg, VolumeStack *stack)
{
...
ccl_device int volume_stack_sampling_method(ccl_addr_space KernelGlobals *kg, VolumeStack *stack)
{
...
ccl_device void kernel_volume_shadow_homogeneous(ccl_addr_space KernelGlobals *kg, PathState *state, Ray *ray, ShaderData *sd, float3 *throughput)
{
	float3 sigma_t;
...
ccl_device void kernel_volume_shadow_heterogeneous(ccl_addr_space KernelGlobals *kg, PathState *state, Ray *ray, ShaderData *sd, float3 *throughput)
{
...
ccl_device_noinline void kernel_volume_shadow(ccl_addr_space KernelGlobals *kg, PathState *state, Ray *ray, float3 *throughput)
{
	ShaderData sd;
...
ccl_device VolumeIntegrateResult kernel_volume_integrate_homogeneous(ccl_addr_space KernelGlobals *kg,
...
ccl_device VolumeIntegrateResult kernel_volume_integrate_heterogeneous_distance(ccl_addr_space KernelGlobals *kg,
 ...
 * scatter or not. */
ccl_device_noinline VolumeIntegrateResult kernel_volume_integrate(ccl_addr_space KernelGlobals *kg,
...
ccl_device void kernel_volume_decoupled_record(ccl_addr_space KernelGlobals *kg, PathState *state,
...
ccl_device void kernel_volume_decoupled_free(ccl_addr_space KernelGlobals *kg, VolumeSegment *segment)
{
...
ccl_device bool kernel_volume_use_decoupled(ccl_addr_space KernelGlobals *kg, bool heterogeneous, bool direct, int sampling_method)
{
...
ccl_device void kernel_volume_stack_init(ccl_addr_space KernelGlobals *kg,
                                         Ray *ray,
                                         VolumeStack *stack)
{
...
ccl_device void kernel_volume_stack_enter_exit(ccl_addr_space KernelGlobals *kg, ShaderData *sd, VolumeStack *stack)
{
