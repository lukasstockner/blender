...
#define ccl_local
#define ccl_local_var __shared__

ccl_device_inline void ccl_local_barrier()
{
	__syncthreads();
	__threadfence_block(); //Needed?
}
...
#define ccl_size_y (gridDim.y*blockDim.y)
#define ccl_local_size_x blockDim.x
#define ccl_local_size_y blockDim.y
