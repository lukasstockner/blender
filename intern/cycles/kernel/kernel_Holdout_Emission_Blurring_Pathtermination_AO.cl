...
/*
 * Note on kernel_ocl_path_trace_holdout_emission_blurring_pathtermination_AO_SPLIT_KERNEL kernel.
 ...
 *
 * rng_coop ---------------------------------------------|--- kernel_ocl_path_trace_holdout_emission_blurring_pathtermination_AO_SPLIT_KERNEL ---|--- Queue_index (QUEUE_HITBG_BUFF_UPDATE_TOREGEN_RAYS)
...
__kernel void kernel_ocl_path_trace_holdout_emission_blurring_pathtermination_AO_SPLIT_KERNEL(
