...
/*
 * The kernel "kernel_ocl_path_trace_QueueEnqueue_SPLIT_KERNEL" enqueues rays of
 * different ray state into their appropriate Queues;
 * 1. Rays that have been determined to hit the background from the
 * "kernel_ocl_path_trace_SceneIntersect_SPLIT_KERNEL" kernel
 ...
 *
 * ray_state -------------------------------------------|--- kernel_ocl_path_trace_QueueEnqueue_SPLIT_KERNEL ---|--- Queue_data (QUEUE_ACTIVE_AND_REGENERATED_RAYS & QUEUE_HITBF_BUFF_UPDATE_TOREGEN_RAYS)
...
__kernel void kernel_ocl_path_trace_QueueEnqueue_SPLIT_KERNEL(
