...
ccl_device_inline int qbvh_node_intersect(ccl_addr_space KernelGlobals *__restrict kg,
                                          const ssef& tnear,
                                          const ssef& tfar,
...
ccl_device_inline int qbvh_node_intersect_robust(ccl_addr_space KernelGlobals *__restrict kg,
                                                 const ssef& tnear,
                                                 const ssef& tfar,
#ifdef __KERNEL_AVX2__
                                                 const sse3f& P_idir,
