...
ccl_device void differential_transfer(__ADDR_SPACE__ differential3 *dP_, const differential3 dP, float3 D, const differential3 dD, float3 Ng, float t)
{
...
ccl_device void differential_incoming(__ADDR_SPACE__ differential3 *dI, const differential3 dD)
{
...
ccl_device void differential_dudv(__ADDR_SPACE__ differential *du, __ADDR_SPACE__ differential *dv, float3 dPdu, float3 dPdv, differential3 dP, float3 Ng)
{
