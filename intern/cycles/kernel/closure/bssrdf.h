...
ccl_device int bssrdf_setup(ccl_addr_space ShaderClosure *sc, ClosureType type)
{
...
ccl_device float bssrdf_gaussian_eval(ccl_addr_space ShaderClosure *sc, float r)
{
...
ccl_device void bssrdf_gaussian_sample(ccl_addr_space ShaderClosure *sc, float xi, float *r, float *h)
{
...
ccl_device float bssrdf_cubic_eval(ccl_addr_space ShaderClosure *sc, float r)
{
...
ccl_device float bssrdf_cubic_pdf(ccl_addr_space ShaderClosure *sc, float r)
{
...
ccl_device void bssrdf_cubic_sample(ccl_addr_space ShaderClosure *sc, float xi, float *r, float *h)
{
	float Rm = sc->data0;
...
ccl_device float bssrdf_none_eval(ccl_addr_space ShaderClosure *sc, float r)
{
	const float Rm = sc->data0;
...
ccl_device void bssrdf_none_sample(ccl_addr_space ShaderClosure *sc, float xi, float *r, float *h)
{
...
ccl_device void bssrdf_sample(ccl_addr_space ShaderClosure *sc, float xi, float *r, float *h)
{
...
ccl_device float bssrdf_pdf(ccl_addr_space ShaderClosure *sc, float r)
{
	if(sc->type == CLOSURE_BSSRDF_CUBIC_ID)
